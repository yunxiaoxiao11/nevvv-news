...
<head>
    ...
    <title>黑马头条</title>
    <!-- 引入样式文件 -->
    <link rel="stylesheet" href="plugins/css/index2.css">
    <!-- 页面样式 -->
...
<div id="app">
    <div class="article">
        ...
        <van-row type="flex" align="center" class="article-header">
            <van-col span="3">
                <van-image round class="article-avatar"
                           src="https://user-center.cdn.bcebos.com/head/raw/uc.101.9801148a.ZIwzSbT-XHnyAjNFeZVQuQ?x-bce-process=image/resize,m_lfit,w_200,h_200&autime=38995"></van-image>
            </van-col>
            <van-col span="16">
            ...
            <#list data as segment>
                ...
                <#else>
                    <van-col span="24" class="article-image">
                        <van-image width="100%" src="${segment.value}"></van-image>
                    </van-col>
                </#if>
            </#list>
        </van-row>
